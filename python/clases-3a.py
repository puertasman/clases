...
# silla: 
#       Atributos: patas, respaldo, color, material, precio, ocupada.
#       Métodos: sentarse, mover, apilar, romperla, comprarla, pintarla.
# coche: 
#       Atributos: marca, modelo, color, cilindrada, potencia, ...
#       Métodos: pintar, arrancar, acelerar, frenar, abrir_puertas, aparcar...
# perro: 
#       Atributos: raza, color, tamaño, peso, edad, nombre.
#       Métodos: comer, ladrar, cagar, mear, pasear, acompar, dormir, despertar...
...
class Animal:
    def __init__(self, nombre, especie, sonido):
        ...
        self.sonido = sonido
        print(f"Se ha creado un {self.especie} llamado {self.nombre}.")

    def hacer_sonido(self):
        print(f"El {self.nombre} hace {self.sonido}.")

perro = Animal("Perro", "Canino", "gluglugluglu")
perro.hacer_sonido()
perro.nombre = "Bobby"
perro.hacer_sonido()
...
class Bicicleta:
    ...
    def __init__(self, marca, tipo, electrica, tamaño):
        ...
        self.tamaño = tamaño
        print(f"Se ha creado una bicicleta {self.marca} de tipo {self.tipo}.")

    def estado(self):
        print(f"La bicicleta {self.marca} está lista para rodar.")

    def __str__(self):
        return f"Bicicleta {self.marca} {self.tipo} {self.tamaño}"

mi_bici = Bicicleta("Orbea", "Montaña", False, "M")
print(mi_bici)

garage = []
garage.append(mi_bici)
...
class Libro:
    ...
    def resumen(self):
        print(f'"{self.titulo}" de {self.autor}, tiene {self.paginas} páginas.')
